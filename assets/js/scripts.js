...
(function() {
    ...
    var bodyEl = document.body,
        ...
        imghero = document.querySelector('.hero-back-mover'),
        imghero1 = document.querySelector('.hero-back-mover-1'),
        canOpen = true,
    ...
    function initEvents() {
        ...
        window.addEventListener('mousemove', throttle(function(ev) {
            ...
            imghero1.style.WebkitTransform = 'perspective(1000px) translate3d(' + transX + 'px,' + transY + 'px,' + transZ + 'px) rotate3d(' + xVal + ',' + yVal + ',0,2deg)';
            imghero1.style.transform = 'perspective(1000px) translate3d(' + transX + 'px,' + transY + 'px,' + transZ + 'px) rotate3d(' + xVal + ',' + yVal + ',0,2deg)';
        }, 100));
